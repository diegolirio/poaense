...
DATABASES = {
    'default': {
        ...
        'NAME': 'campeonato.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 's9e90$o_y&07e9xw(g7h(b_a#9lmb46-0*)(467p2@1gz=g%ub'
...
ROOT_URLCONF = 'poaense.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'poaense.wsgi.application'
